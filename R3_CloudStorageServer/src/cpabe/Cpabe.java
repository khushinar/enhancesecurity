...
public class Cpabe {
	 ...
	 */
       ...
       public static Cpabe getinstance(){
           if(cpabe==null){
               cpabe = new Cpabe();
           }
           return cpabe;
	...
	public void keygen(String pubfile,String mskfile
        ...
        public void keygenprv(String pubfile, String prvfile, String mskfile,
